...
import { MapPin, Image as ImageIcon, Clock, Ticket, Navigation, Loader2, ArrowLeft } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input required className="w-full pl-10 pr-4 py-2.5 border rounded-xl outline-none focus:ring-2 focus:ring-orange-500 border-gray-200" 
                    placeholder="VD: 50.000đ - 150.000đ" value={formData.priceRange} onChange={(e) => setFormData({...formData, priceRange: e.target.value})} />
                </div>
              </div>
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input required className="w-full pl-10 pr-4 py-2.5 border rounded-xl outline-none focus:ring-2 focus:ring-orange-500 border-gray-200" 
                    placeholder="VD: 07:00 - 18:00" value={formData.openingHours} onChange={(e) => setFormData({...formData, openingHours: e.target.value})} />
                </div>
              </div>
            </div>
